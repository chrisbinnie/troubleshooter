...
RUN apt update && apt install netcat -y && apt install telnet -y && apt install traceroute -y && \ 
    ...
    apt install nmap -y && apt install htop -y && apt install strace -y && apt install netstat -y && \
    apt-get clean
